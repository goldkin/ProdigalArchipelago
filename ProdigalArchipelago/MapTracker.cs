...
class MapTracker : MonoBehaviour
{
    ...
    private void SetupDots()
    {
        Dots = [
            ...
            TrackerDot.NewDot("Near Magma Heart", 67, 56, false, () => true, [
            ...
            TrackerDot.NewDot("Boot Shop", 12, -12, false, () => true, [
            ...
            TrackerDot.NewDot("Hackett", -53, -7, false, () => true, [
                new TrackerLocation("Purchase Item", 202, () => CanHit()),
            ]),
            TrackerDot.NewDot("Grant", -49, -13, false, () => true, [
            ...
            TrackerDot.NewDot("Church", -8, -14, false, () => true, [
            ...
            TrackerDot.NewDot("On Farm", 0, -40, false, () => true, [
                new TrackerLocation("Bush Hidden Item", 141, () => true),
            ]),
            TrackerDot.NewDot("Near Bridge", 17, -3, false, () => true, [
                new TrackerLocation("Bush Hidden Item", 137, () => true),
            ]),
            TrackerDot.NewDot("Near Bench", -46, -45, false, () => true, [
                new TrackerLocation("Bush Hidden Item", 139, () => true),
            ]),
            TrackerDot.NewDot("Near River's House", 73, -19, false, () => true, [
                new TrackerLocation("Bush Hidden Item", 162, () => CanHit() || HasLariat()),
            ]),
            TrackerDot.NewDot("Near Old House", 16, 42, false, () => true, [
                new TrackerLocation("Bush Hidden Item", 0, () => CanClimb()),
            ]),
            TrackerDot.NewDot("Near Boot Shop", 7, -11, false, () => true, [
                new TrackerLocation("Crate Hidden Item", 140, () => true),
            ]),
            TrackerDot.NewDot("Near Tidal Mines", 53, -52, false, () => true, [
                new TrackerLocation("Crate Hidden Item", 138, () => CanHit()),
            ]),
            TrackerDot.NewDot("Hidden Dock", 61, -59, false, () => true, [
                new TrackerLocation("Chest Hidden Item", 176, () => CanHit()),
            ]),
            TrackerDot.NewDot("Ashwood's Manor", -24, -13, false, () => true, [
                new TrackerLocation("Plant Hidden Item", 184, () => true),
            ]),
            TrackerDot.NewDot("Colorless Void", 52, -7, true, () => true, [
            ...
            TrackerDot.NewDot("Abandoned Mine", -72, -35, false, () => true, [
                new TrackerLocation("Iron Pick Chest", 2, () => true),
                new TrackerLocation("Lower Chest", 44, () => HasLariat() && HasKnuckle()),
            ]),
            TrackerDot.NewDot("Waterfall Cave", 55, 15, false, () => CanClimb(), [
                new TrackerLocation("Skeleton", 135, () => (HasPick() || (Skips() && HasKnuckle())) && HasLariat()),
            ]),
            TrackerDot.NewDot("Celina's Mine", 45, 34, false, () => Item.Bandana.Acquired() && ((CanClimb() && CanHit()) || (HasKnuckle() && HasLariat())), [
                new TrackerLocation("Mine Treasure", 179, () => HasPick()),
            ]),
            TrackerDot.NewDot("Cursed Grave", -39, 11, false, () => Item.CursedBones.Acquired(), [
            ...
            TrackerDot.NewDot("Various Locations", -70, 63, false, () => true, [
            ...
            TrackerDot.NewDot("Boneyard", -66, 19, true, () => CanHit(), [
            ...
            TrackerDot.NewDot("Tidal Mines", 43, -52, true, () => Item.RustyKey.Acquired(), [
            ...
            TrackerDot.NewDot("Dry Fountain", -28, -19, true, () => true, [
            ...
            TrackerDot.NewDot("Howling Bjerg", -11, -58, true, () => true, [
            ...
            TrackerDot.NewDot("Castle Vann", -12, 32, true, () => Item.HallowedKey.Acquired(), [
            ...
            TrackerDot.NewDot("Magma Heart", 56, 44, true, () => (HasKnuckle() && HasLariat()) || CanClimb(), [
            ...
            TrackerDot.NewDot("Time Out", 52, -3, true, () => true, [
            ...
            TrackerDot.NewDot("Lighthouse", -56, -51, true, () => GameMaster.GM.Save.Data.Recolored, [
            ...
            TrackerDot.NewDot("Crystal Caves", 7, 31, true, () => HasKnuckle(), [
            ...
            TrackerDot.NewDot("Haunted Hall", -30, 15, true, () => Item.BoneKey.Acquired() && CanHit(), [
                ...
                new TrackerLocation("Hidden Crystal Chest", 72, () => HasFlare() && HasHand() && HasKey(Key.HauntedHall, 2) && (HasLariat() || CanLongJump() || HasIceKey()),
            ...
            TrackerDot.NewDot("Siska's Workshop", -56, 42, true, () => HasLariat() && (HasPick() || Item.HallowedKey.Acquired()), [
            ...
            TrackerDot.NewDot("Backrooms", 40, 10, true, () => true, [
                ...
                new TrackerLocation("Near Cracked Wall Chest", 76, () => HasKnuckle() && HasKey(Key.Backrooms, 1) && HasLariat(),
                    () => HasKnuckle() && CanOpen(Key.Backrooms, 81) && HasLariat()),
                new TrackerLocation("Hidden Crystal Chest", 81, () => HasKnuckle() && HasKey(Key.Backrooms, 1) && HasLariat() && (HasKey(Key.Backrooms, 2) || HasIceKey()),
            ...
            TrackerDot.NewDot("Pirate's Pier", 61, -55, true, () => Item.StindlesMap.Acquired() && CanHit(), [
            ...
            TrackerDot.NewDot("Bjerg Castle", -21, -44, true, () => true, [
            ...
            TrackerDot.NewDot("Daemon's Dive", -30, 37, true, () => HasHand2() && Item.HallowedKey.Acquired() && Item.DaemonsKey.Acquired(), [
            ...
            TrackerDot.NewDot("Enlightenment", 11, 45, true, () => CanClimb() && HasHand2() && (HasLariat() || HasFlare()) && ((Item.GatorKey.Acquired() && HasPick()) || HasKnuckle() && (HasLariat() || CanLongJump())) && HasEnoughBlessings(), [
